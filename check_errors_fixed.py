...
# Use triple slash to match the method name mapping logic
cmd = {"action":"telemetry/get/errors","capability":"read","keys":[],"values":[]}
res = send_and_receive(cmd, "get_errors_fixed")
